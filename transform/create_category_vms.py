...
def run_in_parallel():
	params = []
	files = glob.glob(os.path.join(os.getenv("TD"), "vm", "news", "full-domain", "month", "filtered", "*", "*", "*.txt"))
	dest_dir = os.path.join(os.getenv("TD"), "vm", "news", "full-domain", "month", "categories")
